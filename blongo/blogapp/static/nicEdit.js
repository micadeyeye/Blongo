...
/* Edited by micadeyeye to support only chosen textareas */
/*
...
*/
		//var prof_textarea = document.form["index"].getElementsByName("profile");
		var textareas = document.getElementsByTagName("textarea");
			//nicEditors.editors.push(new nicEditor(nicOptions).panelInstance(prof_textarea));
			nicEditors.editors.push(new nicEditor(nicOptions).panelInstance(textareas[0]));
		return nicEditors.editors;
	},
